#!/usr/bin/env python3
"""
OpenRouter Configuration Manager for Open WebUI (Simple Version)
...
class OpenRouterManager:
    ...
    def show_header(self):
        ...
        console.clear()
        header = Panel(
            "🤖 OpenRouter Configuration Manager\nSecure LLM API Integration for Open WebUI",
    ...
    def show_status(self):
        ...
        status_table.add_row("🔌 API Enabled", self.config['ENABLE_OPENROUTER_API'], "✅ Active" if api_enabled else "❌ Inactive")
    ...
    def show_menu(self):
        ...
        console.print("\n🎯 Main Menu:")
        console.print("1. 🔧 Configure OpenRouter API")
        console.print("2. 📊 View Current Configuration")
        console.print("3. 🧪 Test OpenRouter Connection")
        console.print("4. 🔍 Browse Available Models")
        console.print("5. 🐳 Restart Docker Services")
        console.print("6. 📝 Generate .env Template")
        console.print("7. ❓ Help & Documentation")
        console.print("8. 🚪 Exit")

    def configure_api(self):
        """Configure OpenRouter API settings"""
        console.clear()
        console.print(Panel("🔧 OpenRouter API Configuration", style="bold bright_blue"))
        ...
        # Save configuration
        self.save_config()
        console.print("\n💾 Configuration saved!", style="bright_green")
        input("\nPress Enter to continue...")

    def view_config(self):
        """Display current configuration"""
        console.clear()
        console.print(Panel("📊 Current OpenRouter Configuration", style="bold bright_blue"))
        ...
        config_table.add_row("API Enabled", self.config['ENABLE_OPENROUTER_API'], "✅ Active" if enabled else "❌ Inactive")
    ...
    def test_connection(self):
        ...
        console.clear()
        console.print(Panel("🧪 Testing OpenRouter Connection", style="bold bright_blue"))
        ...
        try:
            console.print("🔄 Testing connection...", style="bright_yellow")
            headers = {
            ...
            if response.status_code == 200:
                ...
                console.print(f"✅ Connection successful!", style="bright_green")
                console.print(f"📊 Found {model_count} available models", style="bright_cyan")
                ...
                if model_count > 0:
                    ...
                    if model_count > 5:
                        console.print(f"  ... and {model_count - 5} more", style="dim white")
            else:
                console.print(f"❌ Connection failed: HTTP {response.status_code}", style="bright_red")
    ...
    def browse_models(self):
        ...
        console.clear()
        console.print(Panel("🔍 Browse OpenRouter Models", style="bold bright_blue"))
        ...
        try:
            console.print("🔄 Fetching models...", style="bright_yellow")
            headers = {
                'Authorization': f"Bearer {self.config['OPENROUTER_API_KEY']}",
                'Content-Type': 'application/json'
            }
            ...
            if response.status_code == 200:
                ...
                models_table.add_column("Model ID", style="bright_cyan")
                models_table.add_column("Context", style="bright_green")
                models_table.add_column("Pricing", style="bright_yellow")
                ...
                if len(models) > 20:
                    console.print(f"\n... and {len(models) - 20} more models available", style="dim white")
                ...
                if perplexity_models:
                    console.print(f"\n🔍 Found {len(perplexity_models)} Perplexity models for search:", style="bright_cyan")
                    for model in perplexity_models:
                        console.print(f"  • {model.get('id')}", style="bright_green")
            else:
    ...
    def restart_docker(self):
        ...
        if Confirm.ask("Restart Open WebUI Docker services?"):
            try:
                console.print("🔄 Restarting services...", style="bright_yellow")
                # Stop services
                ...
                console.print("🌐 Open WebUI should be available shortly", style="bright_cyan")
...
"""
    ...
    def show_help(self):
        ...
        console.clear()
        console.print(Panel("❓ Help & Documentation", style="bold bright_blue"))
        ...
        try:
            while True:
                ...
                if choice == "1":
                    ...
                    console.clear()
                    console.print("👋 Goodbye! OpenRouter configuration saved.", style="bright_green")
                    break
            ...
            console.clear()
            console.print("\n👋 Goodbye! Configuration saved.", style="bright_green")
